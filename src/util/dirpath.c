...
initDirPathArray(void)
{
    ...
    pathp = dirPathArray[AFSDIR_SERVER_PTSERVER_CTLSOCK_FILEPATH_ID];
    AFSDIR_SERVER_FILEPATH(pathp, AFSDIR_LOCAL_DIR, AFSDIR_PTSERVER_CTLSOCK_FILE);

    pathp = dirPathArray[AFSDIR_SERVER_VLSERVER_CTLSOCK_FILEPATH_ID];
    AFSDIR_SERVER_FILEPATH(pathp, AFSDIR_LOCAL_DIR, AFSDIR_VLSERVER_CTLSOCK_FILE);
